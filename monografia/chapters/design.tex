...
O logotipo do sistema foi planejado para representar o próprio nome do sistema.
Nexo, que representa a conexão, convergência de vários elementos. Esse nome
conversa com a ideia do projeto em trabalhar o EMA, visto que o objeto que o
aplicativo trabalha para além de registrar o humor do usuário, mas sim
construir uma narrativa diária do estado emocional, conectando informações
contextuais como qualidade do sono, estresse, energia, ansiedade, sentimentos,
emoções, atividades, psicofármacos, consultas, etc.

Portanto, o nome representa exatamente esse propósito, é o que ``dá liga'' a
várias coisas esparsas, dando sentido, racionalizando esses elementos.
...
(?) uma hierarquia visual bem definida, ajda o usuário a interpretar
rápidamente a interface, reduzindo a carga cognitiva e tornando a navegação
mais intuitiva.
...
sistema, de forma mínima e não intrusiva. A proposta aqui era recheiar um pouco
mais a interface para adci

\subsection{Tipografia}

A tipografia escolhida é a Inter, criada por Rasmus Andersson, cujo é
reconhecida justamente pela legibilidade e atenção para que seja bem
renderizada no uso digital. A fonte hoje é usada por diversas plataformas, como
o Figma.

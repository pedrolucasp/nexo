...
\begin{quote}
  ...
  dependem do tipo de software a ser desenvolvido, de quem são seus possíveis
  usuários e da abordagem geral adotada pela organização ao escrever os
  requisitos. Quando expressos como requisitos de usuário, os requisitos
  funcionais são normalmente descritos de forma abstrata, para serem
